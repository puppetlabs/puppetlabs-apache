  ...
  case $::osfamily {
    'redhat': {
      ...
      if versioncmp($apache_version, '2.4') >= 0 {
        ...
        if ( (!($::osfamily == 'redhat' and versioncmp($::operatingsystemrelease, '7.0') == -1) or !($::osfamily == 'redhat' and versioncmp($::operatingsystemrelease, '8.0') == -1)) and !($::operatingsystem == 'Amazon') ) {
          if ($use_systemd) {
            ::apache::mod { 'systemd': }
          }
        }
