...
class apache (
  ...
  $keepalive_request     = $::apache::params::keepalive_request,
  $hostname_lookups      = $::apache::params::hostname_lookups,
  $start_servers         = $::apache::params::start_servers,
  $server_limit          = $::apache::params::server_limit,
  $max_clients           = $::apache::params::max_clients,
  $max_request_per_child = $::apache::params::max_request_per_child,
